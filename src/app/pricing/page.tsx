    ...
    <div className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-gray-500 text-lg">Pick the plan that fits your learning needs</p>
        </div>
        ...
        <div className="mt-16 bg-gray-50 rounded-2xl p-8 text-center">
          ...
          <Link href="/contact" className="mt-4 inline-block text-blue-600 font-medium hover:underline">
            Contact Us &rarr;
          </Link>
        </div>
      </div>
